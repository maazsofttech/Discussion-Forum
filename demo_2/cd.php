...
<br><br>	<form method="POST" class="form-inline" role="form"  >
 ...
 <div class="table-responsive" id="t">
    ...
    $myq = mysql_query("SELECT * FROM admin_data WHERE subject_name = 'Compiler Design' order by link_id desc  LIMIT 20");
    
	  if(isset($_POST['put']))
	{$myq = mysql_query("SELECT * FROM admin_data WHERE subject_name = 'Compiler Design' AND date = '$finalDate' order by link_id desc ");
