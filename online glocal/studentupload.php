...
<form class="form-horizontal" role="form" method="POST"  action="studentupload.php" enctype="multipart/form-data">
...
<td ><input class="form-control" type="text" name="student_name" size="50"/></td>
</tr>
