...
<html>
 ...
 <a href =tc_UserQueries.php><button type="button" class="btn btn-primary">Refresh</button></a></a>
<br>
<br>
...
<?php
 ...
 $f = mysql_query("SELECT * FROM   pro_user_queries  WHERE    subject ='Theory of Computation'         order by Query_ID desc  LIMIT 20");
 ...
 $mn = $_POST['mth'];
	 $finalDate = $dt."-".$mn."-".$yr;
	  ...
	  $f = mysql_query("SELECT * FROM   pro_user_queries WHERE Query_Date ='$finalDate' AND subject ='Theory of Computation' order by Query_ID desc  ");
